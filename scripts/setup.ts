...
async function main() {
  ...
  console.log('L2_RPC_URL:', process.env.L2_RPC_URL);
  console.log('L3_RPC_URL:', process.env.L3_RPC_URL);
  ...
  try {
    ...
    if (!rs.tokenBridgeDeployed) {
      ...
      // Add delay
      console.log('Waiting after deploying token bridge...');
    ...
    if (!rs.l3config) {
      ...
      // Add delay
      console.log('Waiting after L3 chain configuration...');
      await delay(30000); // 30 seconds
    ...
    if (!rs.transferOwnership) {
      ...
      // Add delay
      console.log('Waiting after transferring ownership...');
      await delay(30000); // 30 seconds
